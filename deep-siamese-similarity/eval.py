...
tf.flags.DEFINE_string("eval_filepath", "validation.txt", "Evaluate on this data (Default: None)")
tf.flags.DEFINE_string("vocab_filepath", "runs/1559976598/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1559976598/checkpoints/model-8000", "Load trained model checkpoint (Default: None)")
